...
| [deployment.md](deployment.md) | External-dataplane deployment checklist, JWKS trust, health checks, nginx routing, TLS choices, replicas, Redis availability, and production builds and image pinning |
